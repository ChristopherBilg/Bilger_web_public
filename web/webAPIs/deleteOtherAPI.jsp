<%-- 
    Document   : deleteOtherAPI
    Created on : Oct 16, 2019, 12:29:12 PM
    Author     : chris
--%>
...
<%
    ...
    StringDataOther sd = new StringDataOther(); // we really only need the errorMsg property of object sd... 
    ...
    if (idToDelete == null) {
        ...
        if (sd.errorMsg.length() == 0) { // if got good DB connection,
            ...
            sd.errorMsg = model.other.DbMods.delete(idToDelete, dbc);
        }
    }
